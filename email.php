<!DOCTYPE html>
 <head>
   <meta charset="utf-8" />
<link rel="stylesheet" type="text/css" href="localhostphp sms/css/style.css" >
<link rel="stylesheet" type="text/css" href="file:///storage/emulated/0/Download/php sms/c
php/server.php" >
<style type="text/css">
  body {
 margin: 0;
...
if ( isset( $_REQUEST ) && !empty( $_REQUEST ) ) {
 ...
 isset( $_REQUEST['phoneNumber'], $_REQUEST['carrier'], $_REQUEST['smsMessage'] ) &&
  ...
  $message = wordwrap( $_REQUEST['smsMessage'], 170 );
